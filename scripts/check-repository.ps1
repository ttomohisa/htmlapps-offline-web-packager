...
$required = @(
  ...
  "src\offline-web-packager-core.js",
  "tests\foundation.test.cjs",
  "tests\analyzer.test.cjs",
  "tests\packager.test.cjs",
  "tests\resolver.test.cjs",
  "tests\verification.test.cjs",
  "tests\ux.test.cjs",
  "tests\performance.test.cjs",
  "tests\cross-browser.test.cjs",
  "tests\drop-regression.test.cjs",
  "tests\i18n.test.cjs",
...
foreach ($token in @("bytesAsync", "blobUrlAsync", "window.AppToast", "OfflineWebPackagerCore", "entryHtmlSelect", "outputVerification")) {
...
foreach ($token in @("compressionSetting", "Compress-GzipBytes", "build-size-report.json", "sizeBudget", "DependencyLockPath", "tarballSha256", "__EMBEDDED_ASSET_BUNDLE_JSON__", "AppIconPath", "__APP_ICON_DATA_URI__", "AppCorePath", "__APP_CORE_JS__")) {
